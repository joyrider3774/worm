...
Rnd2 will also select random levels higher than 99 but it will use a common highscore for these levels. This is similar to how it was initially implemented in the previous version.
